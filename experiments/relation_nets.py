...
def run():
    ...
    param_str = f'{args.dataset}_nt={args.n_train}_kt={args.k_train}_qt={args.q_train}_' \
                ...
                f'sampling_method={args.sampling_method}_is_diverisity={args.is_diversity}'
    ...
    # Model #
    #########
    model = RelationNetwork(num_input_channels, 64, 8)
    ...
    # Importance sampling
        ...
        train_dataset_taskloader = DataLoader(
            train_dataset,
            batch_sampler=ImportanceSampler(train_dataset, model.encoder_2d,
