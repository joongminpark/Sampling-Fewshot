...
def main():
    ...
    parser.add_argument(
        "--model_path", type=str,
        default="./models/proto_nets/miniImageNet_nt=5_kt=5_qt=10_nv=5_kv=5_qv=10_dist=l2_sampling_method=True_is_diverisity=True.pth", 
        help="model path")
    parser.add_argument(
    ...
    # Model #
    #########
    model = get_few_shot_encoder(num_input_channels).to(device, dtype=torch.double)
